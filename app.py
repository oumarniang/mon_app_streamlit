...
# Bouton de prédiction : déclenchement de l'inférence lorsque l'utilisateur clique sur "Predict"
if st.button("Predict"):
    ...
    # Formatage du résultat avec séparation des milliers et affichage avec 2 décimales
    resultat = f"Le prix estimé de cette voiture est : {prediction[0]:,.2f} dollars"
    
    # Affichage du résultat sous forme de message de succès
    st.success(resultat)
